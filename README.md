...
- Discover and operate Oodle resources (monitors, dashboards, notifiers, traces, metrics, synthetic monitors, drop rules, log metrics, integrations), run PromQL/log queries, and research current Oodle documentation with a single, predictable workflow.
...
| [oodle-docs](skills/oodle-docs/SKILL.md) | Documentation research workflow — read llms.txt, select relevant docs pages, and read full source files |
